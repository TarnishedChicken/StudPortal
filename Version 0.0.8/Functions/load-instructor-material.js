...
async function retrieveMaterials(){
    ...
    materials_db = await server.getInstructorMaterials(session_id)
...
addBtn.addEventListener('click', () => {
  ...
  fileInput.addEventListener('change', (event) => {
    ...
    form_data.append("material",file)
    server.uploadMaterial(session_id,classes_db[0].unit_id,"NON","NON",form_data)
  });
